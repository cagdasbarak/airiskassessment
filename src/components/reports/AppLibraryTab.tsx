...
import { ShieldCheck, Search, Filter, LayoutGrid, BadgeAlert, BadgeCheck, BadgeHelp, Users, Activity } from 'lucide-react';
    ...
    >
      <div className="flex flex-col md:flex-row gap-4 justify-between items-center mb-2">
        <div className="relative w-full md:max-w-md">
          ...
          <Input placeholder="Search detected AI applications..." className="pl-10 bg-white/50 dark:bg-black/20 border-border/50 rounded-xl" />
        </div>
